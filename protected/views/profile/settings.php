			...
			<div class="form-container">
				<form action="" method="POST" role="form">
					...
					<div class="form-group input-group-sm">
						...
						<input type="text" class="form-control" id="oldPass" placeholder="Input field">
					</div>
					<div class="form-group input-group-sm">
						<label for="">Новый пароль</label>
						<input type="text" class="form-control" id="newPass" placeholder="Input field">
					</div>
					<div class="form-group input-group-sm">
			...
			<div class="form-container">
				<form action="" method="POST" role="form">
					...
					<div class="form-group input-group-sm">
						...
						<input type="text" class="form-control" id="newEmail" placeholder="Input field">
					</div>
					<button type="button" class="btn btn-primary btn-sm" id="saveMailBtn">Сохранить</button>
				</form>
			</div>
			<div class="form-container">
				<form action="" method="POST" role="form">
					...
					<button type="button" class="btn btn-primary btn-sm" id="saveSocBtn">Сохранить</button>
				</form>
			</div>
		</td>
	</tr>
